    ...
    <div class="min-h-screen bg-white flex flex-col">
        <div class="container mx-auto px-4 py-8 flex-grow">
            ...
            <header class="text-center mb-12">
                <h1 class="text-4xl font-bold text-[#073F62] mb-4">Generate Power Bill</h1>
                <p class="text-xl text-[#00A550] max-w-2xl mx-auto">
                    Get Your Customized Power Bill Copy in Less Than 2 Minutes!
                </p>
            </header>
            ...
            <!-- Form Section -->
            <form method="POST" action="{{ route('bill.preview') }}" class="max-w-4xl mx-auto">
                @csrf
                <div class="bg-white shadow-md rounded-lg p-6">
                    ...
                    <div class="mb-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                <label class="block text-gray-700 font-medium mb-2" for="zipcode">Zipcode</label>
                    ...
                    <div class="mb-8">
                        <h3 class="text-2xl font-semibold text-[#073F62] mb-6">Meter Details</h3>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                    ...
                    <!-- Dates Section -->
                    <div class="mb-8">
                        <h3 class="text-2xl font-semibold text-[#073F62] mb-6">Dates</h3>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
